...
class LoginPage(Frame):
    def __init__(self, window):
        ...
        self.window = window
        self.window.geometry("400x250+350+80")
        self.window.configure(bg='powder blue')
        self.configure(bg='powder blue')

        # Creating labels for login page
        self.lb_login_page = Label(self, text='User login page', font='arial', fg='black', bg='powder blue')
        self.lb_user = Label(self, text='Username', font='arial', bg='powder blue')
        self.lb_pass = Label(self, text='Password', font='arial', bg='powder blue')
        ...
        self.lb_status = Label(self, text='', bg='powder blue', font='arial')
...
class RegisterPage(Frame):
    def __init__(self, window):
        ...
        self.lb_fname = Label(self, text='First Name', bg='teal', font='arial')
        self.lb_lname = Label(self, text='Last Name', bg='teal', font='arial')
        self.lb_number = Label(self, text='Mobile number', bg='teal', font='arial')
        self.lb_email = Label(self, text='Email id', bg='teal', font='arial')
        self.lb_new_password = Label(self, text='New Password', bg='teal', font='arial')
        self.lb_confirm_new = Label(self, text='Confirm Password', bg='teal', font='arial')
        ...
        self.lb_status = Label(self, text='', bg='teal', font='arial')
    ...
    def summit(self):
        try:
            ...
            if user_file_data.get(email, 0) != 0:
                self.lb_status.configure(text='User exists. Use another email.')
                return
            ...
            self.reset()
            self.lb_status.configure(text='The account is created successfully.')
...
class DashboardPage(Frame):
    def __init__(self, window):
        ...
        self.window.configure(bg='sandy brown')
        self.configure(bg='sandy brown')

        # label
        self.lb_dashboard = Label(self, text='Dash Board', bg='sandy brown', font='arial')
...
class DepartmentPage(Frame):
    def __init__(self, window):
        ...
        self.upper_frame = Frame(self, bg='teal')
        self.upper_frame = Frame(self, bg='teal')
        self.lower_frame = Frame(self, width=400, height=304, bg='teal')
        ...
        # Labels
        self.lb_depart_id = Label(self.upper_frame, text='Department Id', bg='teal', font='arial')
        self.lb_depart_name = Label(self.upper_frame, text='Department Name', bg='teal', font='arial')
        ...
        self.lb_status = Label(self.upper_frame, text='', bg='teal', font='arial')
        self.lb_status.grid(row=4, column=0)
...
class EmployeePage(Frame):
    def __init__(self, window):
        ...
        self.upper_frame = Frame(self, bg='teal')
        self.lower_frame = Frame(self, width=670, height=245, bg='teal')
        self.lower_frame.pack_propagate(0)

        self.upper_frame.pack(side=TOP)
        self.lower_frame.pack(side=BOTTOM)

        self.lb_id = Label(self.upper_frame, text='Id', bg='teal', font='arial')
        self.lb_fname = Label(self.upper_frame, text='First Name', bg='teal', font='arial')
        self.lb_lname = Label(self.upper_frame, text='Last Name', bg='teal', font='arial')
        self.lb_age = Label(self.upper_frame, text='Age', bg='teal', font='arial')
        self.lb_number = Label(self.upper_frame, text='Mobile number', bg='teal', font='arial')
        self.lb_address = Label(self.upper_frame, text='Address', bg='teal', font='arial')
        ...
        self.lb_choose_depart = Label(self.upper_frame, text='Choose department', bg='teal', font='arial')
        ...
        self.lb_status = Label(self.upper_frame, text='', bg='dark green', font='arial')
